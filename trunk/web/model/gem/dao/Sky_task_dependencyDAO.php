...
class Sky_task_dependencyDAO {
	
	private $table = "sky_task_dependency";
	
	public function Sky_task_dependencyDAO()
	{
	...
	public function create($obj)
	{
		...
		if(!mysql_query($requete)) {
			trigger_error("Unable to create Sky_task_dependency", E_USER_ERROR);
			return;
		}
	...
	public function update($obj)
	{
		...
		if(!mysql_query($requete)){
			trigger_error("Unable to update Sky_task_dependency", E_USER_ERROR);
			return ;		
		}
	...
	public function delete($id)
	{
		...
		if(!$resultat){
			trigger_error("Unable to delete Sky_task_dependency", E_USER_ERROR);
			return;
		}
		else return true ;						
